...
###                   #####         ___ __ _ ____  _  / __| || | /_\ | _ \ __| 
   ...
   #        ##                                  |__/                          
              ...
              - All countries & various modules of SHARE waves 1,2,3,4,5,6,7,8 -
...
It is based on data of: 
    ...
    wave 1  release 8.0.0
    wave 2  release 8.0.0
    wave 3  release 8.0.0
    wave 4  release 8.0.0
	wave 5  release 8.0.0
	wave 6  release 8.0.0
	wave 7  release 8.0.0
...
*>> Define location of waves 1, 2, 3, 4, 5, 6, 7, 8 (release 8.0.0) 

   global wave1 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w1"
   global wave2 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w2"
   global wave3 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w3"       
   global wave4 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w4"
   global wave5 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w5"
   global wave6 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w6"
   global wave7 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w7"
   global wave8 "R:\DataCleaning\waveX\waveX_vers_X_RELEASE\data\D_final_data_versions\scrambled_final_Stata\w8"
  
   global relw1 "rel8-0-0"
   global relw2 "rel8-0-0"
   global relw3 "rel8-0-0"
   global relw4 "rel8-0-0" 
   global relw5 "rel8-0-0"
   global relw6 "rel8-0-0"
   global relw7 "rel8-0-0"
   global relw8 "rel8-0-0"


*>> Define location of easySHARE directory (here the new dataset is generated)

    global easy "R:\DataCleaning\waveX\waveX_vers_X_easySHARE"
...
set more off
  ...
  foreach m in $m { // module loop starts
	...
	// gv_grossnet in w1 has to be copied separately
          copy "$wave1\sharew1_rel8-0-0_gv_grossnet.dta" /// 
               "$easy\data\release\sharew1_rel8-0-0_gv_grossnet.dta" , replace
...
use $easy\data\release\sharew1_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew3_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_cv_r.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_dn.dta, clear
...
// ST Module:
use $easy\data\release\sharew3_rel8-0-0_st.dta, clear
...
// RP Module
use $easy\data\release\sharew3_rel8-0-0_rp.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_dn.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_ac.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_br.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_cf.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_ch.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_ch.dta, clear
...
use  $easy\data\release\sharew1_rel8-0-0_co.dta, clear
     keep mergeid co007_
save $easy\data\temp\sharew1_co_a.dta, replace

*>> w2: 

use  $easy\data\release\sharew2_rel8-0-0_co.dta, clear
     keep mergeid co007_
save $easy\data\temp\sharew2_co_a.dta, replace

*>> w4: 

use  $easy\data\release\sharew4_rel8-0-0_co.dta, clear
     keep mergeid co007_
save $easy\data\temp\sharew4_co_a.dta, replace

*>> w5: 

use  $easy\data\release\sharew5_rel8-0-0_co.dta, clear
     keep mergeid co007_
save $easy\data\temp\sharew5_co_a.dta, replace

*>> w6: 

use  $easy\data\release\sharew6_rel8-0-0_co.dta, clear
     keep mergeid co007_
...
use  $easy\data\release\sharew7_rel8-0-0_co.dta, clear
     keep mergeid co007_
...
use  $easy\data\release\sharew8_rel8-0-0_co.dta, clear
     keep mergeid co007_
...
use $easy\data\release\sharew3_rel8-0-0_cs.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_cc.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_ep.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_ep.dta, clear
...
// Although release 8.0.0 of wave 3 already contains the variable maxgrip
// we keep the generation commands here for illustrative reasons

use $easy\data\release\sharew3_rel8-0-0_gs.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew3_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_hc.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
save $easy\data\temp\sharew1_ho_a.dta, replace

*>> w2: 

use $easy\data\release\sharew2_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
save $easy\data\temp\sharew2_ho_a.dta, replace

*>> w4: 

use $easy\data\release\sharew4_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
save $easy\data\temp\sharew4_ho_a.dta, replace

*>> w5: 

use $easy\data\release\sharew5_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
...
use $easy\data\release\sharew6_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
...
use $easy\data\release\sharew7_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
...
use $easy\data\release\sharew8_rel8-0-0_ho.dta, clear	
	keep mergeid ho001_
...
use $easy\data\release\sharew1_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew2_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew4_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew5_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew6_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew7_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew8_rel8-0-0_iv.dta, clear	
	keep mergeid iv009_
...
use $easy\data\release\sharew5_rel8-0-0_mc.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_ph.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_sn.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_sn.dta, clear
    keep mergeid sn005_* sn006_*  
...
use $easy\data\release\sharew8_rel8-0-0_sn.dta, clear
    keep mergeid sn005_* sn006_*  
...
use $easy\data\release\sharew1_rel8-0-0_sp.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_sp.dta, clear
	keep mergeid sp002_ sp003_1 sp003_2 sp003_3 sp008_ sp009_1 sp009_2 sp009_3
...
use $easy\data\release\sharew4_rel8-0-0_sp.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_sp.dta, clear
    keep mergeid sp002_ sp003_1 sp003_2 sp003_3 sp008_ sp009_1 sp009_2 sp009_3
...
use $easy\data\release\sharew6_rel8-0-0_sp.dta, clear
    keep mergeid sp002_ sp003_1 sp003_2 sp003_3 sp008_ sp009_1 sp009_2 sp009_3
...
use $easy\data\release\sharew7_rel8-0-0_sp.dta, clear
	keep mergeid sp002_ sp003_1 sp003_2 sp003_3 sp008_ sp009_1 sp009_2 sp009_3
...
use $easy\data\release\sharew8_rel8-0-0_sp.dta, clear
	keep mergeid sp002_ sp003_1 sp003_2 sp003_3 sp008_ sp009_1 sp009_2 sp009_3
...
use $easy\data\release\sharew3_rel8-0-0_hs.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_hs.dta, clear
...
*----[22. Extract & Recode Variables from HS]--------------------------- 


*>> w7: 

use $easy\data\release\sharew7_rel8-0-0_rh.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew2_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew4_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew5_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew6_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_gv_health.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_gv_isced.dta, clear   
...
use $easy\data\release\sharew2_rel8-0-0_gv_isced.dta, clear   
	keep mergeid isced1997_r	
...
use $easy\data\release\sharew4_rel8-0-0_gv_isced.dta, clear    
	keep mergeid isced1997_r 	
save $easy\data\temp\sharew4_gv_isced_a.dta, replace


*>> w5: -> replace missings after appending the waves 

use $easy\data\release\sharew5_rel8-0-0_gv_isced.dta, clear   
	keep mergeid isced1997_r	
save $easy\data\temp\sharew5_gv_isced_a.dta, replace


*>> w6: -> replace missings after appending the waves 

use $easy\data\release\sharew6_rel8-0-0_gv_isced.dta, clear   
	keep mergeid isced1997_r	
save $easy\data\temp\sharew6_gv_isced_a.dta, replace


*>> w7: -> replace missings after appending the waves 

use $easy\data\release\sharew7_rel8-0-0_gv_isced.dta, clear   
	keep mergeid isced1997_r	
save $easy\data\temp\sharew7_gv_isced_a.dta, replace


*>> w8: -> replace missings after appending the waves 

use $easy\data\release\sharew8_rel8-0-0_gv_isced.dta, clear   
	keep mergeid isced1997_r	
...
use $easy\data\release\sharew1_rel8-0-0_gv_imputations.dta, clear
    
  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew1_rel8-0-0_cv_r.dta"
	drop if _merge == 2
	drop _merge
...
use $easy\data\release\sharew2_rel8-0-0_gv_imputations.dta, clear
  
  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew2_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
...
use $easy\data\release\sharew4_rel8-0-0_gv_imputations.dta, clear
  
  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew4_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
...
use $easy\data\release\sharew5_rel8-0-0_gv_imputations.dta, clear
  
  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew5_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
...
use $easy\data\release\sharew6_rel8-0-0_gv_imputations.dta, clear

  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew6_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
...
use $easy\data\release\sharew7_rel8-0-0_gv_imputations.dta, clear

  * mergeing with cv_r and technical_variables module is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew7_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
	merge m:1 mergeid using "$easy\data\release\sharew7_rel8-0-0_technical_variables.dta", nogen
...
use $easy\data\release\sharew8_rel8-0-0_gv_imputations.dta, clear

  * mergeing with cv_r because int_year is needed:	
	merge m:1 mergeid using "$easy\data\release\sharew8_rel8-0-0_cv_r.dta"
	drop if interview ==0
	drop if deceased == 1
...
use $easy\data\release\sharew1_rel8-0-0_gv_grossnet.dta, clear
	merge 1:m mergeid using $easy\data\release\sharew1_rel8-0-0_gv_imputations.dta 
...
use $easy\data\release\sharew1_rel8-0-0_dropoff.dta, clear
...
use $easy\data\release\sharew1_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew1_technical_variables_a.dta, replace


*>> w2: 

use $easy\data\release\sharew2_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew2_technical_variables_a.dta, replace


*>> w4: 

use $easy\data\release\sharew4_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew4_technical_variables_a.dta, replace


*>> w5: 

use $easy\data\release\sharew5_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew5_technical_variables_a.dta, replace


*>> w6: 

use $easy\data\release\sharew6_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew6_technical_variables_a.dta, replace


*>> w7: 

use $easy\data\release\sharew7_rel8-0-0_technical_variables.dta, clear
save $easy\data\temp\sharew7_technical_variables_a.dta, replace


*>> w8: 

use $easy\data\release\sharew8_rel8-0-0_technical_variables.dta, clear
...
use $easy\data\release\sharew7_rel8-0-0_gv_big5.dta, clear
...
use $easy\data\release\sharew8_rel8-0-0_gv_big5.dta, clear
...
*----[37. Implement/complete wave/country skip patterns]-----------------------
	...
	foreach var in br010_mod  {
        replace `var' = -13 if wave==3 | wave==6 | wave==7 | wave==8
	}
	...
	replace ep011_mod = -13 if wave == 8
...
*>> Variables only included in SHARELIFE & wave5
    foreach var in books_age10 maths_age10 language_age10 childhood_health vaccinated {
...
*>> Label & Notes for dataset
    label data ""                                                   
    notes drop _dta
    note: {it: easy}SHARE release {cmd: 8.0.0} waves {cmd: $w} /// 
          {it:doi } {cmd: 10.6103/SHARE.easy.800}
    label data "easySHARE release 8.0.0  waves $w  doi 6103./SHARE.easy.800"                       
    
compress
    
saveold $easy\data\easySHARE_rel8-0-0.dta, version(12) replace   
...
*   so that we do not have double numlabels (SPSS has an option to show them): 
   ...
   *>> first write an SPSS script to run from within SPSS:
    ...
    set obs 5
    gen str60 var = ""
    replace var= "GET STATA FILE='$easy/data/easySHARE_rel8-0-0.dta'. " in 1
    replace var= "SAVE OUTFILE  ='$easy/data/easySHARE_rel8-0-0.sav'  " in 2
   ...
   *>> execute SPSS 
    ...
    // Alternatively one can just start SPSS from the Start menue and 
...
use $easy\data\easySHARE_rel8-0-0.dta, clear
savespss "$easy\data\easySHARE_rel8-0-0.sav", replace	
...
saveold $easy\data\easySHARE_rel8-0-0.dta, replace version(12) 
...
cd $easy/data/
zipfile "$easy/data/easySHARE_rel8-0-0.dta" /// 
        "$easy/data/easySHARE_rel8-0-0.sav", /// 
